-- Public Social follows native Social: the post remains readable while media
-- marked sensitive is returned with an explicit concealment flag. The client
-- owns the same blur/reveal treatment as NativeSocialFeedPrimitives.
