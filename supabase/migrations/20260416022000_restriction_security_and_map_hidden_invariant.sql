-- Lock down broad restriction probing and enforce map_hidden server-side on map reads.

revoke execute on function public.get_users_with_active_restriction(uuid[], text) from authenticated;
