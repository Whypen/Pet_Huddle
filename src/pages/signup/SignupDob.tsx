        ...
        <div>
          ...
          <div className="relative">
            ...
            <Input
              ...
              {...register("dob")}
              onChange={(e) => setValue("dob", e.target.value, { shouldValidate: false })}
              onBlur={(e) => setValue("dob", e.target.value, { shouldValidate: true })}
            />
          </div>
          {errors.dob && <p className="text-xs text-red-500 mt-1" aria-live="polite">{errors.dob.message}</p>}
        </div>
